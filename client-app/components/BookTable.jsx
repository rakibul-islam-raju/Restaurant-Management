...
const BookTable = () => {
  return (
    <section className="w-full p-2 sm:p-20 md:p-20 h-full bg-[url('/assets/img/bg_3.jpg.webp')] bg-no-repeat bg-cover bg-center">
      <div className="w-full sm:w-2/3 md:w-1/2 bg-white flex flex-col justify-center p-4 pb-10 rounded-lg">
        ...
        <div className="w-full sm:flex md:flex ">
          <div className="w-full sm:w-1/2 md:w-1/2 mr-3 ">
            <label for="name" class="leading-7 text-sm text-gray-800">
              Name
            </label>
            <input
              type="text"
            ...
            <label for="phone" class="leading-7 text-sm text-gray-800">
              Phone
            </label>
            <input
              type="text"
            ...
            <label for="time" class="leading-7 text-sm text-gray-800">
              Time
            </label>
            <input
              type="time"
          ...
          <div className="w-full sm:w-1/2 md:w-1/2">
            ...
            <label for="date" class="leading-7 text-sm text-gray-800">
              Date
            </label>
            <input
              type="date"
            ...
            <label for="person" class="leading-7 text-sm text-gray-800">
              Person
            </label>
            <input
              type="text"
